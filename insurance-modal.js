        ...
        <div class="insurance-modal" id="insuranceModal">
            <div class="insurance-modal-content">
                ...
                <div class="insurance-modal-body">
                    ...
                    <div class="insurance-verification-box">
                        ...
                        <ul>
                            ...
                            <li><strong>Call our office</strong> at <a href="tel:385-504-1334" " style="color: var(--primary); font-weight: 600;">(385) 504-1334</a> to discuss payment options and insurance questions</li>
                        </ul>
                    </div>
                ...
                <div class="insurance-modal-footer">
                    <button class="btn" onclick="proceedToScheduleFromInsurance(); ">Continue to Schedule</button>
