...
server.listen(PORT, () => {
  ...
  console.log(`- ADHD Treatment: http://localhost:${PORT}/services/adhd.html`);
  console.log(
    `- Anxiety Treatment: http://localhost:${PORT}/services/anxiety.html`
  );
  console.log(
    `- Depression Treatment: http://localhost:${PORT}/services/depression.html`
  );
  console.log(`- PTSD Treatment: http://localhost:${PORT}/services/ptsd.html`);
});
