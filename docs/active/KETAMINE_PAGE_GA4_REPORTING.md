# How Ketamine Therapy Page Appears in GA4 Reports

**Page URL:** https://allenpsychiatry.net/ketamine-therapy  
...
**Direct Link:**
https://analytics.google.com/analytics/web/?utm_source=OGB&utm_medium=app&authuser=0#/a357957755p492555456/reports/explorer?params=_u..nav%3Dmaui&collectionId=engagement&ruid=engagement-pages,engagement,pages&r=engagement-pages
...
**Events Tracked on This Page:**

#### **Automatic Events:**
- ✅ `page_view` - Fires automatically when page loads
  - **Event Label:** None (automatic)
  - **Count:** Every page view

#### **Custom Conversion Events:**

**1. `schedule_appointment_click`**
- **Event Labels:**
  - `Schedule Button - Ketamine` (header button)
  - `Schedule Link - Inline Text` (in content)
  - `Schedule Button - Ketamine CTA` (main CTA section)
  - `Schedule Button - Ketamine CTA Section` (bottom section)
  - `Schedule Button - Footer` (footer link)
- **Location:** Multiple buttons/links throughout the page
- **Value:** 1 (each click)
...
**The ketamine-therapy page appears in GA4 as:**
- **Page path:** `/ketamine-therapy`
- **Page title:** "Ketamine Therapy Utah | PTSD & Trauma Treatment | Treatment-Resistant Depression | Allen Psychiatry"
- **Automatic tracking:** `page_view` events
- **Custom events:** `schedule_appointment_click`, `phone_call_click`, `email_click`
